...
subtitle: 'MoviLens recommendation system'
author: "Vladimir Pedchenko"
email: "paralogyX@gmail.com"
date: "10/09/2021"
header-includes:
- \usepackage{titling}
...
```{r var-rem1, echo=FALSE, message=FALSE, warning=FALSE}
...
At the end, the model was tested on the hold-out dataset and the model reported root square mean error `r RMSE(validation_predict, validation$rating)`, this is lower than project requirement 0.86490. Rating timestamp is not used in the model, so the model can be used for "online" recommendations.
...
-   Instead of trying to predict exact rating, try to predict if user **u** would like movie **i** or not;
